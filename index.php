...
<?php include "header.php"; ?>	
	...
	<div id="slides" class="cover-slides">
		<ul class="slides-container">
			<li class="text-left">
				<img src="foodimgs/istockphoto-1383962772-612x612.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Buksmi Bites Restaurant</strong></h1>
							<p class="m-b-40">Have It Your Way,   <br> 
							 Best Naija Delicacies</p>
			...
			<li class="text-left">
				<img src="foodimgs/photo-1584440772680-63bec399984b.jpeg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>We like  <br> to eat well.</strong></h1>
							<p class="m-b-40">Buksmi Bites Restaurant is Serving Authentic Naija Food.And Our Restaurant's 
<br> 
							Ambience is very good with well trained staff and open kitchen concept...</p>
			...
			<li class="text-left">
				<img src="foodimgs/istockphoto-1212447634-612x612.jpg" alt="">
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Buksmi Bites Restaurant with Buksmi</strong></h1>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">Buskmi Bites Restaurant</span>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Gallery</h2>
						<p>Delicious food Pictures for Buksmi Bites Restaurant Listed Here </p>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						...
						<p>"if you build a greater experience, customers advertise your business, words of mouth is very powerful"</p>
					</div>
				</div>
			</div>
			<div class="row">
