			...
			<div class="row">
				<div class="col-lg-12">
					<div class="heading-title text-center">
						<h2>Special Menu</h2>
						<p>Every day is a good day to get a bite from buksmi bites restaurant</p>
					</div>
				</div>
			</div>
					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						...
						<?php } ?>
							<div class="carousel-item text-center active">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Luffy</strong></h5>
								<h6 class="text-dark m-0">Review : Amazing</h6>
								<p class="m-0 pt-3">
